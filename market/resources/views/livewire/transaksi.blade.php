<div>
    <div class="row">
        <div class="col-3">
            <div class="mb-1">
                <button class="btn btn-outline-primary" wire:click='transaksibaru'>Transaksi Baru</button>
            </div>
            @if ($kodetransaksi)
            <div>
        ...
        <div class="col-9">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="4"></td>
                        <td><button class="btn btn-info" wire:click='selesai'>SELESAI</button></td>
                        <td><button class="btn btn-danger" wire:click='batal'>batal</button></td>
